...
- **THEN** the CLI calls `GET /clinicians/:id` and displays the clinician's id, name, email, enabled, npi, and credentials
...
- **THEN** the CLI calls `GET /clinicians/me` and displays the clinician's id, name, email, enabled, npi, and credentials
